...
/**
 * Represents the activity that displays a pay back bill.
 * @author sarahpadlipsky
 * @version December 8, 2016
 */
public class ViewPayBackBill extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.view_pay_back_bill_activity);
    ...
    // Sets the bill's receiver.
    TextView userReceiveText = (TextView) findViewById(R.id.userReceiveOfBillForViewBill);
